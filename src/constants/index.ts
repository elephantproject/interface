...
import { ChainId, JSBI, Percent, Token, WETH } from '@elephantdefi/sdk'
...
export const ROUTER_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_MAINNET]: '0x1563499C436Ce793ee39990ED978A8194c446374',
...
export const GOVERNANCE_TOKEN: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.HARMONY_MAINNET]: new Token(
    ...
    '0xc2e3A6fC29427a6B32eB155848e6fc2694B96895',
    18,
    'ELEPHANT',
    'Elephant'
  ),
...
export const MASTER_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_MAINNET]: '0xE1060727Aba052B8c18167157A4ff0B165d50957',
...
export const PIT_BREEDER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x7F90F02fDa31103b7f6F4db9889226ac3Cd45Dae',
...
export const PIT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.HARMONY_TESTNET]: new Token(
    ChainId.HARMONY_TESTNET,
    '0x5A5FccE88cB849a7C2b8092D122617fDeD220423',
    18,
    'xElephant',
    'ElephantPit'
  )
