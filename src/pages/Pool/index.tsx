...
import { Pair, JSBI } from 'elephantdexsdk'
...
const ResponsiveButtonthree = styled(ButtonGray)`
  width: fit-content;
  ${({ theme }) => theme.mediaWidth.upToSmall`
    width: 48%;
  `};
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            <TitleRow style={{ marginTop: '1rem' }} padding={'0'}>
              ...
              <ButtonRow>
                ...
                <ResponsiveButtonthree id="join-pool-button" as={Link} padding="6px 8px" to={addLiquidityUrl}>
                  <Text fontWeight={500} fontSize={16}>
                    <Link to={'/find'}>Import Pool</Link>
                  </Text>
                </ResponsiveButtonthree>
              </ButtonRow>
            </TitleRow>
