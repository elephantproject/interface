...
const CODE_LINK = 'https://github.com/elephantproject'
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          ...
          <MenuItem id="link" href="https://discord.gg/6fFvUghhg7">
          ...
          <MenuItem id="link" href="https://twitter.com/elephant_dexn">
            <Twitter size={14} />
            Twitter
          </MenuItem>
