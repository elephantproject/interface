...
export function defaultColors(darkMode: boolean): Colors {
  return {
    ...
    // Added:
    tokenButtonGradientStart: '#e39987',
    tokenButtonGradientEnd: '#f07023',
    customCardGradientStart: '#e39987',
    customCardGradientEnd: '#f07023'
  }
}

export function elephantColors(darkMode: boolean): Colors {
  return {
    // base
    white,
    black,
...
export function harmonyColors(darkMode: boolean): Colors {
  return {
    ...
    // backgrounds / greys
    bg1: darkMode ? '#212429' : '#FFFFFF',
    bg2: darkMode ? '#090403' : '#fff8f6',
    bg3: darkMode ? '#40444F' : '#EDEEF2',
    bg4: darkMode ? '#f68660' : '#CED0D9',
    bg5: darkMode ? '#93796a' : '#93796a',
    ...
    secondary2: darkMode ? '#17000b26' : '#F6DDE8',
    secondary3: darkMode ? '#17000b26' : '#FDEAF1',
    // 0xCdF0156909c0543A3d4BD4Be12d85B6b3c3A57aC // eth
    // bc1qft8lpwpgr8xdkpgva868p0j58fhhvz6km7d28c // btc
    // GDEZDZYWGBCIXWEMEZBTUE4B5H6N4WBYKVY6GQBKCFIL5HOUUNUOI6S3 // stellar
    // 1896435929 //
    // other
    red1: '#FD4040',
    red2: '#F82D3A',
...
export function colors(blockchain: Blockchain, darkMode: boolean): Colors {
  switch (blockchain) {
    ...
    default:
      return elephantColors(darkMode)
  }
}
